...
L.Util.extend(L.KML, {
  ...
  parseGroundOverlay: function(xml) {
    ...
    function _parse(xml2) {
      ...
      for (var i = 0; i < xml2.childNodes.length; i++) {
        ...
        if (key === "Icon") {
          ioptions = _parse(e);
          if (ioptions.href) {
            options2.href = ioptions.href;
          }
        } else if (key === "href") {
          options2.href = value;
        } else if (key === "color") {
          options2.opacity = parseInt(value.substring(0, 2), 16) / 255;
          options2.color = "#" + value.substring(6, 8) + value.substring(4, 6) + value.substring(2, 4);
        }
      }
      return options2;
    }
    var options = {};
    options = _parse(xml);
    if (latlonbox.getElementsByTagName("rotation")[0] !== void 0) {
...
leaflet-kml/L.KML.js:
  (*!
  	Copyright (c) 2011-2015, Pavel Shramov, Bruno Bergot - MIT licence
  *)
*/
//# sourceMappingURL=leaflet-kml.js.map
