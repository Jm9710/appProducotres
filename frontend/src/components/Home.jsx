  ...
  return (
    <div className="container-fluid p-0 min-vh-100 d-flex flex-column">
      ...
      <div className="d-flex align-items-center justify-content-between bg-light shadow-sm p-2">
        <div className="d-flex align-items-center">
          <button className="btn btn-primary me-2">Cargar Archivos</button>
          <button className="btn btn-primary me-2">Eliminar Archivos</button>
          <button className="btn btn-primary me-2">Cargar KML</button>
